    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-4 left-4 lg:top-4 lg:left-4 lg:bottom-auto z-40
                     bg-gray-900/95 backdrop-blur-md border-2 border-gray-700
                     hover:border-gray-600 rounded-lg shadow-2xl px-4 py-3
        ...
        >
          ...
          {consumedItems.length > 0 && (
            <span className="ml-1 px-2 py-0.5 bg-red-900/50 text-red-300 text-xs rounded-full">
              {consumedItems.length} used
            </span>
          )}
        </button>
      )}
      ...
      {isOpen && (
        <div className="fixed bottom-4 left-4 right-4 lg:bottom-auto lg:top-4 lg:left-4 lg:w-96 z-40">
